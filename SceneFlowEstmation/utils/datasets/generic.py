...
class SceneFlowDataset(Dataset):
    def __init__(self, nb_points, rm_ground=False, use_fg_inds=False, cache=None):
        """
    ...
    def subsample_points(self, sequence, ground_truth, mask=None):
        """
        ...
        # sequence[3] = sequence[3][ind1] / 255.0
