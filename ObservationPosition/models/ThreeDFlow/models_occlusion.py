...
from pointconv_util import (All2AllCostVolume, Conv1d, CostVolume,
...
class ThreeDFlow(nn.Module):
    def __init__(self,  is_training, bn_decay=None):
        ...
        self.layer0 = PointNetSaModule(npoint=2048, radius=RADIUS1, nsample=32, in_channels=3,mlp=[16,16,32],mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, use_fps=False)
        ...
        self.flow_pred4 = FlowPredictor([32,64,32,3],mlp=[128,64,64], is_training = is_training , bn_decay = bn_decay, npoint=2048)
    ...
    def forward(self, xyz1,xyz2,color1,color2,label,mask):
        ...
        l0_mask,_,_,_,= torch.split(mask,2048,1) # 2048
