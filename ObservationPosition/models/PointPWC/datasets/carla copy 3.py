...
class SceneFlowDataset(Dataset):
    def __init__(self, nb_points, rm_ground=False, use_fg_inds=True, use_hybrid_sample=True, cache=None):
        """
    ...
    def subsample_points(self, sequence, ground_truth, mask):
        ...
        if self.hybrid_sample:
            mask[0] = self.hybrid_sample_points(mask[0], num_pts=4500)
            mask[1] = self.hybrid_sample_points(mask[1], num_pts=4500)
