...
from models.PointPWC.pointconv_util import PointConv, PointConvD, PointWarping, UpsampleFlow, PointConvFlow
from models.PointPWC.pointconv_util import SceneFlowEstimatorPointConv
from models.PointPWC.pointconv_util import index_points_gather as index_points, index_points_group, Conv1d, square_distance
import time
...
class PointConvSceneFlowPWC8192selfglobalPointConv(nn.Module):
    def __init__(self):
        ...
        #l1: 2048
        self.level1 = PointConvD(1024, feat_nei, 64 + 3, 64)
    ...
    def forward(self, xyz1, xyz2, color1, color2):
        ...
        return pc1_l0, pc2_l0, feat1_l0_1, feat2_l0_1
