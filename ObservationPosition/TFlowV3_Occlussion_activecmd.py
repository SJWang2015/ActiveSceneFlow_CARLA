...
from utils.soflow import  PointConvTransFlowV2, PointConvTransFlowV3, PointWarping, UpsampleFlow, \
    SceneFlowEstimatorProbPointConv, SceneFlowEstimatorProbPointConv2  # , PointNetSetAbstraction
...
if __name__ == "__main__":
    ...
    # def __init__(self, npoint=10000, nsample=8, in_channel=128, mlp=[128, 128, 128]):
    ...
    # _, output = model(input, input, f_input, f_input, f_input, input)
